...
contract MimeTokenUpgradeable is Initializable, OwnableUpgradeable, IMimeToken {
    ...
    function initialize(string memory name_, string memory symbol_, bytes32 merkleRoot_) public initializer {
        __Ownable_init();
